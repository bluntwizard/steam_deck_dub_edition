...
import { DialogOptions, DialogInterface } from '../../types/dialog';
...
class Dialog implements DialogInterface {
  ...
  private addEventListeners(): void {
    ...
    if (this.options.closeOnOutsideClick && this.overlayElement) {
   ...
   */
  setContent(content: string | HTMLElement): Dialog {
  ...
  setTitle(title: string): Dialog {
    ...
    let titleElement = this.dialogElement.querySelector(`.${styles.dialogTitle}`) as HTMLElement;
