...
describe('Gallery Component', () => {
  ...
  test('should initialize with custom options', () => {
    ...
    const customGallery = new Gallery(customOptions);
  ...
  test('should create gallery grid for multiple images', () => {
    ...
    const galleryGrid = mockContainer.querySelector('div[class*="galleryGrid"]');
  ...
  test('should use figcaption for gallery item captions', () => {
    ...
    const captions = mockContainer.querySelectorAll('div[class*="galleryCaption"]');
    ...
    const galleryImages = mockContainer.querySelectorAll('div[class*="galleryItem"] img');
  ...
  test('should open lightbox when gallery image is clicked', () => {
    ...
    const galleryImage = mockContainer.querySelector('div[class*="galleryItem"] img');
  ...
  test('should close lightbox', () => {
    ...
    expect(gallery.announceForScreenReaders).toHaveBeenCalledWith('Lightbox closed');
  });
  ...
  test('should navigate lightbox images', () => {
    ...
    expect(gallery.updateLightboxImage).toHaveBeenCalled();
    expect(gallery.announceForScreenReaders).toHaveBeenCalledWith('Image 2 of 3');
    ...
    expect(gallery.updateLightboxImage).toHaveBeenCalled();
    expect(gallery.announceForScreenReaders).toHaveBeenCalledWith('Image 1 of 3');
    ...
    expect(gallery.updateLightboxImage).toHaveBeenCalled();
    expect(gallery.announceForScreenReaders).toHaveBeenCalledWith('Image 3 of 3');
  });
