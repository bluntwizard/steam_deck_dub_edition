...
describe("PreferencesDialog Component", () => {
  ...
  describe("Preferences Controls", () => {
    ...
    test("should create preference controls based on the configuration", () => {
      ...
      const fontSizeSlider = container.querySelector(
        'input[type="range"][name="appearance.fontSize"]',
      );
      ...
      const reduceMotionToggle = container.querySelector(
        'input[type="checkbox"][name="accessibility.reduceMotion"]',
      );
  ...
  describe("Save and Reset Functionality", () => {
    ...
    test("should call onReset callback and reset preferences to initial values when reset button is clicked", () => {
      ...
      const themeSelectAfterReset = container.querySelector(
        'select[name="theme"]',
      );
  ...
  describe("API Methods", () => {
    ...
    test("setPreferences should update multiple preferences at once", () => {
      ...
      const notificationsToggle = container.querySelector(
        'input[name="notifications.enabled"]',
      );
