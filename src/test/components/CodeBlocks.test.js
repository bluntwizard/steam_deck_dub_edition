...
describe('CodeBlocks Component', () => {
  ...
  test('initializes with default options', () => {
    const defaultCodeBlocks = new CodeBlocks();
  ...
  test('initializes with custom options', () => {
    const customCodeBlocks = new CodeBlocks({
  ...
  test('auto initializes when autoInit is true', () => {
    const autoInitCodeBlocks = new CodeBlocks({ autoInit: true });
  ...
  test('processes pre code blocks', () => {
    ...
    code.textContent = 'function test() {\n  console.log("Hello");\n}';
  ...
  test('handles content-inserted event', () => {
    ...
    const event = new CustomEvent('content-inserted', {
      detail: { section }
    });
