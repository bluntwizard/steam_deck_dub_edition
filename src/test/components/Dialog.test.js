...
describe('Dialog', () => {
  ...
  describe('Event Handling', () => {
    test('should add event listeners when created', () => {
      ...
      expect(document.addEventListener).toHaveBeenCalledWith('keydown', dialog.handleKeyDown);
      expect(dialog.overlayElement.addEventListener).toHaveBeenCalledWith('click', dialog.handleOutsideClick);
    });
    ...
    test('should not add escape key listener if closeOnEscape is false', () => {
      ...
      expect(document.addEventListener).not.toHaveBeenCalledWith('keydown', dialog.handleKeyDown);
    });
    ...
    test('should not add outside click listener if closeOnOutsideClick is false', () => {
      ...
      expect(dialog.overlayElement.addEventListener).not.toHaveBeenCalledWith('click', dialog.handleOutsideClick);
  ...
  describe('Visibility Control', () => {
    ...
    test('should remove event listeners when dialog is closed', () => {
      ...
      expect(document.removeEventListener).toHaveBeenCalledWith('keydown', dialog.handleKeyDown);
    });
  });
  ...
  describe('Content Management', () => {
    test('should update content when setContent is called with string', () => {
      ...
      expect(dialog.dialogElement.querySelector('.dialogContent').innerHTML).toBe('Original content');
      
      dialog.setContent('Updated content');
      
      expect(dialog.dialogElement.querySelector('.dialogContent').innerHTML).toBe('Updated content');
    });
    ...
    test('should update content when setContent is called with HTMLElement', () => {
      ...
      expect(dialog.dialogElement.querySelector('.dialogContent').contains(newContent)).toBe(true);
    });
