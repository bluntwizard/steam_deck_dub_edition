...
describe("SettingsTabs", () => {
  ...
  describe("Initialization", () => {
    test("should initialize with default options when autoInit is true", () => {
      const settingsTabs: SettingsTabs = new SettingsTabs();
    ...
    test("should not initialize when autoInit is false", () => {
      const settingsTabs: SettingsTabs = new SettingsTabs({ autoInit: false });
    ...
    test("should create tabs based on the tabs array option", () => {
      ...
      const settingsTabs: SettingsTabs = new SettingsTabs({ tabs });
    ...
    test("should mark the first tab as active by default", () => {
      ...
      expect(
        settingsTabs.tabButtons.get("tab1").getAttribute("aria-selected"),
      ).toBe("true");
      expect(settingsTabs.tabPanes.get("tab1").hidden).toBe(false);
      expect(
        settingsTabs.tabButtons.get("tab2").getAttribute("aria-selected"),
      ).toBe("false");
  ...
  describe("Tab Switching", () => {
    ...
    test("should dispatch tab-change event when switching tabs", () => {
      ...
      settingsTabs.tabsElement.addEventListener(
        "tab-change",
        mockEventListener,
      );
  ...
  describe("Tab Management", () => {
    test("should add a new tab using addTab", () => {
      const initialTabs = [{ id: "tab1", label: "Tab 1" }];
