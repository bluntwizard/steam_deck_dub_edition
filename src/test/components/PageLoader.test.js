...
describe('PageLoader', () => {
  ...
  describe('Visibility Control', () => {
    test('should show loader when show method is called', () => {
      ...
      expect(pageLoader.loaderElement.classList.contains('visible')).toBeTruthy();
    ...
    test('should hide loader when hide method is called', () => {
      ...
      expect(pageLoader.visible).toBeFalsy();
      expect(pageLoader.loaderElement.classList.contains('visible')).toBeFalsy();
      expect(pageLoader.loaderElement.classList.contains('fadeOut')).toBeTruthy();
      expect(document.dispatchEvent).toHaveBeenCalledWith(
        expect.objectContaining({
      ...
      expect(pageLoader.loaderElement.classList.contains('fadeOut')).toBeFalsy();
  ...
  describe('Event Listeners', () => {
    test('should setup automatic progress tracking events when autoHide is true', () => {
      ...
      expect(document.addEventListener).toHaveBeenCalledWith('content-loaded', expect.any(Function));
      expect(document.addEventListener).toHaveBeenCalledWith('ajax-complete', expect.any(Function));
    });
