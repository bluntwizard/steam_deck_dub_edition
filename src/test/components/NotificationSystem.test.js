...
// Mock CSS module
jest.mock('../../components/NotificationSystem/NotificationSystem.module.css', () => ({
...
describe('NotificationSystem', () => {
  ...
  describe('Initialization', () => {
    ...
    test('should create container elements for different positions', () => {
      ...
      positions.forEach(position => {
        const containerEl = document.getElementById(`notification-container-${position}`);
        expect(containerEl).toBeTruthy();
        expect(containerEl.classList.contains('notificationContainer-mock')).toBe(true);
      });
    });
  ...
  describe('Showing Notifications', () => {
    test('should show a notification', () => {
      ...
      expect(notificationEl.querySelector('.message-mock').textContent).toBe('Test notification');
    });
    ...
    test('should show a notification with options', () => {
      ...
      expect(notificationEl.querySelector('.title-mock').textContent).toBe('Notification Title');
      expect(notificationEl.querySelector('.message-mock').textContent).toBe('Notification message');
    ...
    test('should queue notifications when max visible is reached', () => {
      ...
      expect(notificationSystem.notificationQueue[0].message).toBe('Notification 3');
      ...
      const notificationElsAfter = document.querySelectorAll('.notification-mock');
  ...
  describe('Notification Updates', () => {
    test('should update notification content', () => {
      ...
      expect(notificationEl.querySelector('.title-mock').textContent).toBe('Original Title');
      expect(notificationEl.querySelector('.message-mock').textContent).toBe('Original message');
      expect(notificationEl.classList.contains('info-mock')).toBe(true);
      ...
      expect(notificationEl.querySelector('.title-mock').textContent).toBe('Updated Title');
      expect(notificationEl.querySelector('.message-mock').textContent).toBe('Updated message');
      expect(notificationEl.classList.contains('success-mock')).toBe(true);
    });
  });
  ...
  describe('Notification Events', () => {
    test('should dispatch events when showing and dismissing notifications', () => {
      ...
      expect(shownSpy.mock.calls[0][0].detail.message).toBe('Test notification');
      ...
      expect(dismissedSpy.mock.calls[0][0].detail.message).toBe('Test notification');
  ...
  describe('Cleanup', () => {
    test('should destroy properly', () => {
      ...
      expect(document.querySelectorAll('.notificationContainer-mock').length).toBe(6); // 6 positions
      ...
      expect(document.querySelectorAll('.notification-mock').length).toBe(0);
      expect(document.querySelectorAll('.notificationContainer-mock').length).toBe(0);
