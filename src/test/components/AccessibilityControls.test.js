...
describe('AccessibilityControls', () => {
  ...
  beforeEach(() => {
    ...
    // Import component
    AccessibilityControls = require('../../components/AccessibilityControls/AccessibilityControls').default;
  ...
  test('should toggle font size when control is clicked', () => {
    ...
    document.body.classList.contains = jest.fn(className => className === 'largest-text');
    fontSizeButton.click();
